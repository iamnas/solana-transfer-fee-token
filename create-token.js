...
const tt = await sendAndConfirmTransaction(connection, tx, [ payer, mintKeypair ]);
console.log(tt);
...
//     }),
//   );
//   const tt = await sendAndConfirmTransaction(connection, tx, [ payer, mint ]);
//   console.log(tt);
// })();